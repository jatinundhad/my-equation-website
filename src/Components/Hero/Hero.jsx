    ...
    <div>
      <div className="hero text-3xl mx-9 md:mx-32 flex justify-between flex-wrap lg:flex-nowrap h-fit lg:h-screen lg:max-h-[750px]">
        <motion.section
            ...
            transition={{ duration: 0.5 }} className="mt-20 font-semibold leading-[70px] w-full lg:w-[55%]">
          <motion.p initial={{ x: -100, opacity: 0 }}
              animate={{ opacity: 1, x: 0 }}
              transition={{ duration: 0.5, delay: 0.2 }} className="text-transparent bg-clip-text bg-gradient-to-r from-purple-400 via-pink-500 to-red-500 text-[1.4em] md:text-[1.7em]">
          ...
          <motion.p initial={{ x: -100, opacity: 0 }}
              animate={{ opacity: 1, x: 0 }}
              transition={{ duration: 0.5, delay: 0.4 }} className="mt-8 text-[30px] leading-[40px]">
          ...
          <motion.div initial={{ x: -100, opacity: 0 }}
              animate={{ opacity: 1, x: 0 }}
              transition={{ duration: 0.5, delay: 0.6 }}  className="leading-[25px]">
        ...
        <motion.section
            ...
            initial={{ x: 100, opacity: 0 }}
            transition={{ duration: 0.5, delay: 0.7 }} className="hero-img w-4/5 lg:w-[45%] mx-auto mt-[50px] h-fit">
          <dotlottie-player
